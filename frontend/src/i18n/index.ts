  ...
  en: {
    translation: {
      ...
      accessibility: {
        ...
        colorBlindDesc: 'Adjust colors for color vision deficiency',
        colorBlindNone: 'None',
        ...
        shortcutTab: 'Navigate forward',
        shortcutShiftTab: 'Navigate backward',
        shortcutActivate: 'Activate button or link',
        shortcutEscape: 'Close dialog or menu',
  ...
  zh: {
    translation: {
      ...
      accessibility: {
        ...
        fontSize: '字体大小',
        fontSizeDesc: '调整文字大小以增强可读性',
        fontSizeNormal: '正常',
        fontSizeLarge: '大',
        fontSizeXLarge: '特大',
        colorBlind: '色盲模式',
        colorBlindDesc: '为色觉缺陷调整颜色',
        colorBlindNone: '无',
        colorBlindProtanopia: '红色盲',
        colorBlindDeuteranopia: '绿色盲',
        colorBlindTritanopia: '蓝色盲',
        keyboardShortcuts: '键盘快捷键',
        shortcutTab: '向前导航',
        shortcutShiftTab: '向后导航',
        shortcutActivate: '激活按钮或链接',
        shortcutEscape: '关闭对话框或菜单',
        skipNav: '跳过导航',
